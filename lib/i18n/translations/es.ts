...
export const es: Translations = {
  ...
  footer: {
    ...
    serviceLinks: [
      { href: "/services/build", label: "Build & Development" },
      { href: "/services/design", label: "Design & Experience" },
      { href: "/services/conversion", label: "Conversion & Revenue" },
      { href: "/services/growth", label: "Growth & Ongoing" },
    ],
